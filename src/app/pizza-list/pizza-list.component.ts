...
export class PizzaListComponent implements OnInit {
  ...
  user: User = new User('Cron', 'Alfred', '1989-05-23','');
  ...
  ngOnInit() {
    ...
    this.route.data.subscribe(
      data => this.pizzas = data.pizzas
    );

    //this.ingredientService.getIngredients().subscribe(ingredients => console.log(ingredients));
